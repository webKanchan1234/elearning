...
<div class="container-fluid bg-dark">
    <div class="row">
        <img src="./img/img1.jpg" alt="course" style="height: 300px; width:100%; object-fit:cover;box-shadow:10px;">
    </div>
</div>
<div class="container">
    ...
    <form action="" method="POST">
        <div class="form-group row">
            ...
            <div>
                <input type="submit" class="btn btn-primary mx-4" value="View" name="" id="" onclick="">
            </div>
        </div>
    </form>
</div>
...
<div class="container">
<?php
if(isset($requestParamList)&& count($requestParamList)>0)
{
?>
